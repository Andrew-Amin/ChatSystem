...
public class SettingActivity extends AppCompatActivity {
    ...
    private boolean updateImage , hasBasics ,firstTime;
    ...
    private void retrieveUserInfo() {
        rootRef.child("Users").child(currentUser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.hasChild("uName") && dataSnapshot.hasChild("image")) {
                ...
                if (task.isSuccessful())
                {
                    filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            rootRef.child("Users").child(currentUser).child("image").setValue(uri.toString())
