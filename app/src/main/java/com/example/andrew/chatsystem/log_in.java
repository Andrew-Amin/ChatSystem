                ...
                .addOnCompleteListener(log_in.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            Query searchQuery = rootRef.child("Doctors").orderByChild("uID").startAt(currentUserID).endAt(currentUserID + "\uf8ff");
                            searchQuery.addListenerForSingleValueEvent(new ValueEventListener()
                            {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    {
                                        Toast.makeText(log_in.this, "Use (Doctors) version for this account", Toast.LENGTH_LONG).show();
