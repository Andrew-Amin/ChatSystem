...
public class PreviewMHActivity extends AppCompatActivity {
    ...
    private TextView age , gender , weight , smoking , alcohol , diabetes , hyper , psych , edit_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( PreviewMHActivity.this, MedicalHistory.class);
                intent.putExtra("currentUserID" ,userID);
                intent.putExtra("has_MH" , "has_MH");
    ...
    private void initializeFields() {
        ...
        edit_btn = (TextView)findViewById(R.id.preview_MH_edit_btn);
    }
}
