...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessagesViewHolder> {
    ...
    public class MessagesViewHolder extends RecyclerView.ViewHolder {
       ...
       // senderMessageTextDate, receiverMessageTextDate ;
        ...
        public MessagesViewHolder(@NonNull View itemView) {
            ...
            //receiverChatImage = itemView.findViewById(R.id.customMsg_receiverChatImage);
            //senderChatImage = itemView.findViewById(R.id.customMsg_senderChatImage);
        }
    }
    ...
    public void onBindViewHolder(@NonNull final MessagesViewHolder messagesViewHolder, int i) {
        ...
        if(fromMessageType.equals("text"))
        {
          ...
          //  messagesViewHolder.senderChatImage.setVisibility(View.GONE);
            // messagesViewHolder.receiverChatImage.setVisibility(View.GONE);
...
/*
        if(fromMessageType.equals("image"))
        {
            ...
            if(fromUserID.equals(msgSenderID))
            {
                messagesViewHolder.senderChatImage.setVisibility(View.VISIBLE);
                Picasso.get().load(messages.getMessage()).placeholder(R.drawable.no_image).into(messagesViewHolder.senderChatImage);
            }

            else
            {
                messagesViewHolder.receiverImage.setVisibility(View.VISIBLE);
                messagesViewHolder.receiverChatImage.setVisibility(View.VISIBLE);
                Picasso.get().load(messages.getMessage()).placeholder(R.drawable.no_image).into(messagesViewHolder.receiverChatImage);
            }
