...
public class DoctorsContactsFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Contacts , ContactsViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull final ContactsViewHolder holder, int position, @NonNull Contacts model) {
                ...
                rootRef.child("Users").child(usersIDs).addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        {
                            rootRef.child("Doctors").child(usersIDs).addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    if (dataSnapshot.exists()) {

                                        //holder.IsDoctorImg.setImageResource(R.drawable.ic_speciality);
                                        //holder.IsDoctorImg.setVisibility(View.VISIBLE);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.contactsItem_remove:
                removeContact(receiverName , receiverID);
                return true;
    ...
    public static class ContactsViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView onlineIcon;// , IsDoctorImg ;
        ...
        public ContactsViewHolder(@NonNull View itemView) {
           ...
           // IsDoctorImg = itemView.findViewById(R.id.iv_is_doctor);
        }
    }
